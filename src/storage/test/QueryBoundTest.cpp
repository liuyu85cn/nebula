...
TEST(QueryBoundTest, FlagsBoundVertexTest) {
    int original_max_sub_vertices = FLAGS_max_sub_vertices;
    FLAGS_max_sub_vertices = 5;
    fs::TempDir rootPath("/tmp/QueryBoundTest.XXXXXX");
    std::unique_ptr<kvstore::KVStore> kv = TestUtils::initKV(rootPath.path());
    ...
    LOG(INFO) << "Check the results...";
    checkResponse(resp, FLAGS_max_sub_vertices, 12, 10001, 7, true);
    FLAGS_max_sub_vertices = original_max_sub_vertices;
}
